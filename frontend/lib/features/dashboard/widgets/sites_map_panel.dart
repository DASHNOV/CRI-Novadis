...
/// Recherche + carte de tous les sites, fiche avec « Itinéraire ». En couleur,
/// les sites où l'utilisateur est déjà intervenu (tout son historique — ses
/// propres CRI pour un technicien).
///
/// Occupe la hauteur que lui donne son parent : page plein écran
/// (`SitesMapPage`) ou bloc de hauteur fixe (accueil technicien).
class SitesMapPanel extends ConsumerStatefulWidget {
  const SitesMapPanel({super.key});

  @override
  ConsumerState<SitesMapPanel> createState() => _SitesMapPanelState();
}

class _SitesMapPanelState extends ConsumerState<SitesMapPanel> {
